...
DualTex::DualTex() : _angle(0), _prevTime(0), _autorotate(1), _rotateLeft(0), _rotateRight(0)
{
}

void DualTex::ProcessInput(int key, int action)
{
...
void DualTex::Shutdown()
{
    delete _cube;
    delete _plane;
}

void DualTex::SetMatrices()
{
...
void DualTex::Resize(int w, int h)
{
    glViewport(0, 0, w, h);
    _width = w;
    _height = h;
...
void DualTex::CompileAndLinkShader()
{
    try
    {
