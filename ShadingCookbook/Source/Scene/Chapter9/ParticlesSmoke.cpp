...
ParticlesSmoke::ParticlesSmoke() : _width(1024), _height(768), _drawBuf(1), _time(0), _dt(0)
{
}

void ParticlesSmoke::ProcessInput(int key, int action)
{
}

void ParticlesSmoke::InitScene()
{
...
void ParticlesSmoke::Update(float t)
{
    _dt = t - _time;
    _time = t;
}

void ParticlesSmoke::Render()
{
...
void ParticlesSmoke::Shutdown()
{
}

void ParticlesSmoke::Resize(int x, int y)
{
    glViewport(0, 0, x, y);
    _width = x;
    _height = y;
...
void ParticlesSmoke::InitBuffers()
{
    _nParticles = 1000;
...
float ParticlesSmoke::RandFloat()
{
    return (float)rand() / RAND_MAX;
}

void ParticlesSmoke::CompileAndLinkShaders()
{
    try
    {
        _shader.CompileShader("Shaders/ParticlesSmoke/ParticlesSmoke.vert");
        _shader.CompileShader("Shaders/ParticlesSmoke/ParticlesSmoke.frag");
...
void ParticlesSmoke::SetMatrices()
{
