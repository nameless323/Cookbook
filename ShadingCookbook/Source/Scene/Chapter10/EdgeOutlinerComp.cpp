...
void EdgeOutlinerComp::ProcessInput(int key, int action)
{
...
void EdgeOutlinerComp::InitScene()
{
...
void EdgeOutlinerComp::Render()
{
    ...
    _compShader.Use();
    glDispatchCompute(_width / 25, _height / 25, 1);
...
void EdgeOutlinerComp::Update(float t)
{
...
void EdgeOutlinerComp::SetMatrices()
{
...
void EdgeOutlinerComp::Resize(int w, int h)
{
    glViewport(0, 0, w, h);
    _width = w;
    _height = h;
...
void EdgeOutlinerComp::CompileAndLinkShader()
{
    try
    {
        _shader.CompileShader("Shaders/EdgeOutlinerComp/EdgeOutlinerComp.vert");
        _shader.CompileShader("Shaders/EdgeOutlinerComp/EdgeOutlinerComp.frag");
        _shader.Link();
        _shader.Validate();
        _shader.Use();

        _compShader.CompileShader("Shaders/EdgeOutlinerComp/EdgeOutlinerComp.comp");
        _compShader.Link();
